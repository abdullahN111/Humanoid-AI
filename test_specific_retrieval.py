...
async def test_specific_retrieval():
    print("Testing specific retrieval for known content...")
    ...
    try:
        ...
        # We know from earlier that we have content about "Docusaurus blogging features"
...
def main():
    asyncio.run(test_specific_retrieval())
